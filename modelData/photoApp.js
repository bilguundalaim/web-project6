...
(function () {
  ...
  const commentsOfPhotoWithUser = function (userId) {
    console.log(userId);
    const userPhotosCount = photos.filter(function (photo) {
    ...
    return {
      photoCount: userPhotosCount,
      commentCount: userCommentsCount,
      commentsOfUser: userComments,
    };
  };
  ...
  const cs142models = {
    ...
    commentsOfPhotoWithUser: commentsOfPhotoWithUser,
  };
